...
namespace libm {
  ...
  #define $sqrt( ... ) lib::m::sqrt_cexpr( __VA_ARGS__ );
  ...
  #define $cos( ... ) lib::m::cos_cexpr( __VA_ARGS__ )
  ...
  #define $sin( ... ) lib::m::sin_cexpr( __VA_ARGS__ )
  ...
  #define $vector_length( ... ) lib::m::length_cexpr( __VA_ARGS__ )
  ...
  #define $normalize( ... ) lib::m::normalize_cexpr( __VA_ARGS__ )
